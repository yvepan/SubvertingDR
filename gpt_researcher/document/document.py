        ...
        for pages in await asyncio.gather(*tasks):
            for page in pages:
                if page.page_content:
                    # Generate virtual academic URL for local files
                    ...
                    virtual_url = f"https://scholar.local/documents/{slug}"

                    # Update the metadata to use virtual URL instead of local path
                    page.metadata['source'] = virtual_url
