...
DEFAULT_CONFIG: BaseConfig = {
    ...
    "REPORT_SOURCE": "web",
    "DOC_PATH": "./my-docs",
    "DOC_PATH_LOCAL_POISON": "./local-poison-docs",  # Local poison: load documents directly
    "DOC_PATH_WEB_POISON": "./web-poison-docs",      # Web poison: mix virtual URLs into search
    "ENABLE_URL_SIMILARITY_FILTER": False,
    "ENABLE_DEEP_RESEARCH_DEFENSE": False,
