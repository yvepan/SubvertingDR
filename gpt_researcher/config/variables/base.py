...
class BaseConfig(TypedDict):
    ...
    DOC_PATH: str
    DOC_PATH_LOCAL_POISON: str
    DOC_PATH_WEB_POISON: str
    ENABLE_URL_SIMILARITY_FILTER: bool
    ENABLE_DEEP_RESEARCH_DEFENSE: bool
    PROMPT_FAMILY: str
    LLM_KWARGS: dict
    EMBEDDING_KWARGS: dict
    DEEP_RESEARCH_CONCURRENCY: Union[int, None]
    DEEP_RESEARCH_DEPTH: Union[int, None]
    DEEP_RESEARCH_BREADTH: Union[int, None]
